...
agents = {
    ...
    'pattern_matching_6': pattern_matching(15, False, False, decay = 1.1),
    'pattern_matching_22': pattern_matching(7, False, True, decay = 1.1),
    'pattern_matching_42': pattern_matching(3, False, True, decay = 1.1),
    'pattern_matching_62': pattern_matching(15, False, True, decay = 1.1),
    'pattern_matching_22': pattern_matching(7, True, True, decay = 1.1),
    'pattern_matching_42': pattern_matching(3, True, True, decay = 1.1),
    'pattern_matching_62': pattern_matching(15, True, True, decay = 1.1)
}
...
def self_popular_12pattern_3715(observation, configuration):
