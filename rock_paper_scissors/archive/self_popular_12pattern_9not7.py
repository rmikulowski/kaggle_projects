...
agents = {
    ...
    'pattern_matching_1': pattern_matching(9, False, False, decay = 1.001),
    'pattern_matching_2': pattern_matching(9, False, False, decay = 1.1),
    ...
    'pattern_matching_12': pattern_matching(9, True, False, decay = 1.001),
    'pattern_matching_22': pattern_matching(9, False, True, decay = 1.1),
...
def self_popular_12pattern(observation, configuration):
